            ...
            <ScrollView>
                ...
                <ShadowView className='bg-white px-6 pt-10 pb-10' >
                    <Text style={{ fontSize: 16 }} className='leading-8 font-medium text-neutral-800'>
                        ...
                        2025년 CES 등 글로벌 박람회에서는 AI 기반 웨어러블 기기와 스마트 장난감 등 펫테크가 주목받았다. 예를 들어, ‘헬스가드’와 같은 웨어러블 기기는 반려견의 활동량, 수면 패턴, 심박수를 실시간으로 측정해 건강 이상을 조기에 발견할 수 있도록 돕는다. 스마트 장난감은 보호자가 외출 중에도 앱으로 반려견의 운동과 스트레스 해소를 도울 수 있게 한다.{"\n"}{"\n"}
